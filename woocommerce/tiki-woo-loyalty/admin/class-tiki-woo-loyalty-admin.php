		 ...
		 if ( ! current_user_can( 'manage_options' ) ) {
		  ...
		  <div class="wrap">
			...
			<nav class="nav-tab-wrapper">
			  <a href="?page=tiki_woocommerce_menu" class="nav-tab <?php if($tab===null):?>nav-tab-active<?php endif; ?>">TIKI SDK</a>
			  <a href="?page=tiki_woocommerce_menu&tab=coupon" class="nav-tab <?php if($tab==='coupon'):?>nav-tab-active<?php endif; ?>">Coupons</a>
			  <a href="?page=tiki_woocommerce_menu&tab=loyalty" class="nav-tab <?php if($tab==='loyalty'):?>nav-tab-active<?php endif; ?>">Loyalty</a>
			</nav>
